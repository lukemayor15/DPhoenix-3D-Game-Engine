...
//class LITSMovement : public DPhoenix::Engine
//{
//private:
...
//
//public:
//	LITSMovement(HINSTANCE hInstance);
//	~LITSMovement();
//
...
//	void LITSMovement::HandleEvents(DPhoenix::IEvent* e);
//
...
//	void LITSMovement::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / specifically handles textured primitives with directional lights
//	//and fog
//	void LITSMovement::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / now with normal mapping!
//	void LITSMovement::RenderLitTexNormPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / now with normal mapping!
...
//	void LITSMovement::RenderBillboardSprite(DPhoenix::BillboardSprite * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render static mesh with subsets
//	void LITSMovement::RenderBasicModel(DPhoenix::BasicModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render static mesh with subsets
//	void LITSMovement::RenderBasicModelNormal(DPhoenix::BasicModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render animated lit mesh with subsets
//	void LITSMovement::RenderSkinnedModel(DPhoenix::SkinnedModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render animated lit normal mapped mesh with subsets
//	void LITSMovement::RenderSkinnedModelNormal(DPhoenix::SkinnedModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//#pragma region LITSMethods
//
//	bool LITSMovement::CheckPointInRect(int pointX, int pointY, RECT rect);
//	void LITSMovement::CheckMouseHoverMenu();
//	void LITSMovement::CheckMouseClickMenu();
//
//	void LITSMovement::CheckMouseHoverTurns();
//	void LITSMovement::CheckMouseClickTurns();
//
//	//for movment
//	void LITSMovement::CheckMouseClickRoute();
//	void LITSMovement::CheckSelectableRoute();
//	void LITSMovement::ResetPath();
...
//LITSMovement::LITSMovement(HINSTANCE hInstance)
//	: Engine(hInstance)
//{
...
//bool LITSMovement::Init(bool fullScreen)
//{
...
//void LITSMovement::UpdateScene(float dt)
//{
...
//}
//
//void LITSMovement::BuildGeometryBuffers()
//{
...
//}
//
//void LITSMovement::InitAudio()
//{
//
//}
//
//void LITSMovement::RenderSprite(DPhoenix::Sprite * sprite, ID3DX11EffectTechnique * tech, bool isHUD)
//{
...
//}
//
//void LITSMovement::RenderColorPrimitive(DPhoenix::PrimitiveInstance * model,
//	ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
...
//void LITSMovement::RenderSkybox(DPhoenix::Sky* skybox,
//	ID3D11DeviceContext* dc)
//{
//	skybox->Draw(dc, mCamera);
//}
//
//void LITSMovement::RenderBillboardSprite(DPhoenix::BillboardSprite * sprite,
//	ID3DX11EffectTechnique * tech)
//{
//	//create view / projection matrix
//	XMMATRIX view = mCamera->GetView();
