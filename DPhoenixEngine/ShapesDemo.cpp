...
//class ShapesDemo : public DPhoenix::Engine
//{
//private:
...
//
//	DPhoenix::PrimitiveInstance* mColorBox;
//	DPhoenix::PrimitiveInstance* mColorSphere;
//	DPhoenix::PrimitiveInstance* mColorGrid;
//
//public:
...
//	void ShapesDemo::HandleEvents(DPhoenix::IEvent* e);
//
...
//bool ShapesDemo::Init(bool fullScreen)
//{
...
//
//	mGeoGen->CreateBox(1.0f, 1.0f, 1.0f, *mBox);
//
...
//	mProjection = XMMatrixPerspectiveFovLH(0.25f * XM_PI,
...
//	//(using color.fx)
//	RenderColorPrimitive(mColorBox, activeColorTech);
...
//	debugText << "Position x: " << mColorBox->mPosition.x <<
//		" | y: " << mColorBox->mPosition.y <<
//		" | Z: " << mColorBox->mPosition.z << std::endl;
//	debugText << "Sclae x: " << mColorBox->mScale.x << 
//		" | y: "<< mColorBox->mScale.y << 
//		" | Z: " << mColorBox->mScale.z << std::endl;
//	debugText << "Rotation x: " << mColorBox->mRotation.x <<
//		" | y: " << mColorBox->mRotation.y <<
//		" | Z: " << mColorBox->mRotation.z << std::endl;
//	
//
...
//		case DIK_D:
//			mVelocity.x = 500.0f;
//			mColorBox->mPosition.x += 0.0025f;
//			mColorSphere->mPosition.x += 0.0025f;
//			mColorGrid->mPosition.x += 0.0025f;
//			break;
//
//		case DIK_A:
//			mVelocity.x = -500.0f;
...
//		case DIK_W:
//			mVelocity.y = 500.0f;
//			mColorBox->mPosition.y += 0.0025f;
//			mColorSphere->mPosition.y += 0.0025f;
//			mColorGrid->mPosition.y += 0.0025f;
//			break;
//		case DIK_S:
//			mVelocity.y = -500.0f;
//			mColorBox->mPosition.y -= 0.0025f;
...
//		case DIK_E:
//			mVelocity.y = 500.0f;
//			mColorBox->mPosition.z += 0.0025f;
//			mColorSphere->mPosition.z += 0.0025f;
//			mColorGrid->mPosition.z += 0.0025f;
//			break;
//		case DIK_Q:
//			mVelocity.y = -500.0f;
//			mColorBox->mPosition.z -= 0.0025f;
...
//			break;
//		case DIK_Z:
//			mColorBox->mRotation.x += 0.0025f;
//			mColorSphere->mRotation.x += 0.0025f;
//			mColorGrid->mRotation.x += 0.0025f;
//			break;
//		case DIK_X:
//			mColorBox->mRotation.y += 0.0025f;
//			mColorSphere->mRotation.y += 0.0025f;
//			mColorGrid->mRotation.y += 0.0025f;
//			break;
//		case DIK_C:
//			mColorBox->mRotation.z += 0.0025f;
//			mColorSphere->mRotation.z += 0.0025f;
//			mColorGrid->mRotation.z += 0.0025f;
//			break;
//		case DIK_UP:
//			mColorBox->mScale.y += 0.0025f;
//			mColorSphere->mScale.y += 0.0025f;
//			mColorGrid->mScale.y += 0.0025f;
//			break;
//		case DIK_DOWN:
//			mColorBox->mScale.x -= 0.0025f;
//			mColorSphere->mScale.y -= 0.0025f;
//			mColorGrid->mScale.y -= 0.0025f;
//			break;
//			//color lerp
...
//}
//
//void ShapesDemo::RenderSprite(DPhoenix::Sprite * sprite, ID3DX11EffectTechnique * tech, bool isHUD)
//{
...
//}
//
//void ShapesDemo::RenderColorPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
//	float scaleX = mScreenScale.x;
...
//	XMMATRIX viewProj;
//
//	//an idenity matrix is standard and used as a basis
//	//for other calulations
//	//build the biew matrix (looking down the z axis)
//	//change for camera pos and look back to orginal
//	XMVECTOR pos = XMVectorSet(3.0f, 0.0f, -10.0f, 1.0f);
//	XMVECTOR target = XMVectorSet(0.0f, 0.0f, 1.0f, 1.0f );
//	XMVECTOR up = XMVectorSet(0.0f, 1.0f, 0.0f, 0.0f);
//
//	mView = XMMatrixLookAtLH(pos, target, up);
//	
//	//create view / projection matrix *multiply / concatentate)
//	//these represent the camera
//	
//	viewProj = XMMatrixMultiply(mView, mProjection);
//
