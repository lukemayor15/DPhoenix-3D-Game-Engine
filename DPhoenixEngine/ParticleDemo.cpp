...
//class ParticleDemo : public DPhoenix::Engine
//{
//private:
...
//	void ParticleDemo::HandleEvents(DPhoenix::IEvent* e);
//
...
//	void ParticleDemo::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance* model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / spefically handles textured primtives with directional lights abd fog
//	void ParticleDemo::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / with normal mapping
//	void ParticleDemo::RenderLitTexNormPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / now wit normal mapping
//	void RenderSkybox(DPhoenix::Sky* skybox, ID3D11DeviceContext* dc);
//
//	void ParticleDemo::RenderBillboardSprite(DPhoenix::BillboardSprite * model,
//		ID3DX11EffectTechnique * tech);
//};
//
...
//void ParticleDemo::InitCollectables()
//{
...
//bool ParticleDemo::Init(bool fullScreen)
//{
...
//}
//
//void ParticleDemo::BuildGeometryBuffers()
//{
...
//}
//
//void ParticleDemo::RenderSprite(DPhoenix::Sprite * sprite, ID3DX11EffectTechnique * tech, bool isHUD)
//{
...
//}
//
//void ParticleDemo::RenderColorPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
//	float scaleX = mScreenScale.x;
...
//}
//
//void ParticleDemo::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
//	float scaleX = mScreenScale.x;
...
//}
//
//void ParticleDemo::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
...
//}
//
//void ParticleDemo::RenderLitTexNormPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
...
//void ParticleDemo::RenderSkybox(DPhoenix::Sky* skybox,
//	ID3D11DeviceContext* dc)
//{
//	skybox->Draw(dc, mCamera);
//}
//
//void ParticleDemo::RenderBillboardSprite(DPhoenix::BillboardSprite * sprite, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
