...
//class SpotLightDemo : public DPhoenix::Engine
//{
//private:
...
//
//public:
//	SpotLightDemo(HINSTANCE hInstance);
//	~SpotLightDemo();
//
...
//	void SpotLightDemo::HandleEvents(DPhoenix::IEvent* e);
//
...
//	void SpotLightDemo::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance* model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / spefically handles textured primtives with directional lights abd fog
//	void SpotLightDemo::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / with normal mapping
//	void SpotLightDemo::RenderLitTexNormPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//};
//
...
//#endif
//
//	SpotLightDemo theApp(hInstance);
//
...
//SpotLightDemo::SpotLightDemo(HINSTANCE hInstance)
//	: Engine(hInstance)
//{
...
//void SpotLightDemo::InitCollectables()
//{
...
//void SpotLightDemo::InitScenery()
//{
...
//bool SpotLightDemo::Init(bool fullScreen)
//{
...
//}
//
//void SpotLightDemo::BuildGeometryBuffers()
//{
...
//}
//
//void SpotLightDemo::RenderSprite(DPhoenix::Sprite * sprite, ID3DX11EffectTechnique * tech, bool isHUD)
//{
...
//}
//
//void SpotLightDemo::RenderColorPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
//	float scaleX = mScreenScale.x;
...
//}
//
//void SpotLightDemo::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
//	float scaleX = mScreenScale.x;
...
//}
//
//void SpotLightDemo::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
...
//}
//
//void SpotLightDemo::RenderLitTexNormPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
