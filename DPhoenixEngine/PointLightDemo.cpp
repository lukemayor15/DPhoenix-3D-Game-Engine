...
//class PointLightDemo : public DPhoenix::Engine
//{
//private:
...
//
//public:
//	PointLightDemo(HINSTANCE hInstance);
//	~PointLightDemo();
//
...
//	void PointLightDemo::HandleEvents(DPhoenix::IEvent* e);
//
...
//	void PointLightDemo::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance* model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / spefically handles textured primtives with directional lights abd fog
//	void PointLightDemo::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / with normal mapping
//	void PointLightDemo::RenderLitTexNormPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//};
//
...
//#endif
//
//	PointLightDemo theApp(hInstance);
//
...
//PointLightDemo::PointLightDemo(HINSTANCE hInstance)
//	: Engine(hInstance)
//{
...
//void PointLightDemo::InitCollectables()
//{
...
//void PointLightDemo::InitScenery()
//{
...
//bool PointLightDemo::Init(bool fullScreen)
//{
...
//void PointLightDemo::UpdateScene(float dt)
//{
...
//}
//
//void PointLightDemo::BuildGeometryBuffers()
//{
...
//}
//
//void PointLightDemo::RenderSprite(DPhoenix::Sprite * sprite, ID3DX11EffectTechnique * tech, bool isHUD)
//{
...
//}
//
//void PointLightDemo::RenderColorPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
//	float scaleX = mScreenScale.x;
...
//}
//
//void PointLightDemo::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
//	float scaleX = mScreenScale.x;
...
//}
//
//void PointLightDemo::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
...
//}
//
//void PointLightDemo::RenderLitTexNormPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
