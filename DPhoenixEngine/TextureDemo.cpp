...
//class TextureDemo : public DPhoenix::Engine
//{
//private:
...
//	void TextureDemo::HandleEvents(DPhoenix::IEvent* e);
//
...
//	void TextureDemo::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance* model,
...
//TextureDemo::TextureDemo(HINSTANCE hInstance)
//	: Engine(hInstance)
//{
...
//bool TextureDemo::Init(bool fullScreen)
//{
...
//}
//
//void TextureDemo::BuildGeometryBuffers()
//{
...
//}
//
//void TextureDemo::RenderSprite(DPhoenix::Sprite * sprite, ID3DX11EffectTechnique * tech, bool isHUD)
//{
...
//}
//
//void TextureDemo::RenderColorPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
//	float scaleX = mScreenScale.x;
...
//}
//
//void TextureDemo::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
//	float scaleX = mScreenScale.x;
