...
//class LITSUI : public DPhoenix::Engine
//{
//private:
...
//	void LITSUI::HandleEvents(DPhoenix::IEvent* e);
//
...
//	void LITSUI::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / specifically handles textured primitives with directional lights
//	//and fog
//	void LITSUI::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / now with normal mapping!
//	void LITSUI::RenderLitTexNormPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / now with normal mapping!
...
//	void LITSUI::RenderBillboardSprite(DPhoenix::BillboardSprite * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render static mesh with subsets
//	void LITSUI::RenderBasicModel(DPhoenix::BasicModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render static mesh with subsets
//	void LITSUI::RenderBasicModelNormal(DPhoenix::BasicModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render animated lit mesh with subsets
//	void LITSUI::RenderSkinnedModel(DPhoenix::SkinnedModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render animated lit normal mapped mesh with subsets
//	void LITSUI::RenderSkinnedModelNormal(DPhoenix::SkinnedModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//#pragma region LITSMethods
//
//	bool LITSUI::CheckPointInRect(int pointX, int pointY, RECT rect);
//	void LITSUI::CheckMouseHoverMenu();
//	void LITSUI::CheckMouseClickMenu();
//
//	void LITSUI::CheckMouseHoverTurns();
//	void LITSUI::CheckMouseClickTurns();
...
//LITSUI::LITSUI(HINSTANCE hInstance)
//	: Engine(hInstance)
//{
...
//bool LITSUI::Init(bool fullScreen)
//{
...
//void LITSUI::UpdateScene(float dt)
//{
...
//				mPlayerTeam->CalculateTPPool(); mEnemyTeam->ResetTeamTurn();
//			}
//
//			break;
//		}
...
//		else
//		{
//			mCamera->mGoalPosition.x = currentFocus.x - currentCharacter->mModelInstance->mForwardVector.x * 15.0f;
//			mCamera->mGoalPosition.y = currentFocus.y;
//			mCamera->mGoalPosition.z = currentFocus.z - currentCharacter->mModelInstance->mForwardVector.z * 15.0f;
//		}
...
//}
//
//void LITSUI::BuildGeometryBuffers()
//{
...
//}
//
//void LITSUI::InitAudio()
//{
//
//}
//
//void LITSUI::RenderSprite(DPhoenix::Sprite * sprite, ID3DX11EffectTechnique * tech, bool isHUD)
//{
...
//}
//
//void LITSUI::RenderColorPrimitive(DPhoenix::PrimitiveInstance * model,
//	ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
...
//void LITSUI::RenderSkybox(DPhoenix::Sky* skybox,
//	ID3D11DeviceContext* dc)
//{
//	skybox->Draw(dc, mCamera);
//}
//
//void LITSUI::RenderBillboardSprite(DPhoenix::BillboardSprite * sprite,
//	ID3DX11EffectTechnique * tech)
//{
//	//create view / projection matrix
//	XMMATRIX view = mCamera->GetView();
