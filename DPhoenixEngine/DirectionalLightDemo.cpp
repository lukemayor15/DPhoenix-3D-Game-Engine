...
//class DirectionalLightDemo : public DPhoenix::Engine
//{
//private:
...
//
//public:
//	DirectionalLightDemo(HINSTANCE hInstance);
...
//	void DirectionalLightDemo::HandleEvents(DPhoenix::IEvent* e);
//
...
//	void DirectionalLightDemo::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance* model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / spefically handles textured primtives with directional lights abd fog
//	void DirectionalLightDemo::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//};
//
...
//#endif
//
//	DirectionalLightDemo theApp(hInstance);
//
...
//DirectionalLightDemo::DirectionalLightDemo(HINSTANCE hInstance)
//	: Engine(hInstance)
//{
//	mMainWndCaption = "Directional light Demo";
//
...
//void DirectionalLightDemo::InitCollectables()
//{
...
//void DirectionalLightDemo::InitScenery()
//{
...
//bool DirectionalLightDemo::Init(bool fullScreen)
//{
...
//void DirectionalLightDemo::OnResize()
//{
//	Engine::OnResize();
//
...
//void DirectionalLightDemo::UpdateScene(float dt)
//{
...
//}
//
//void DirectionalLightDemo::BuildGeometryBuffers()
//{
...
//}
//
//void DirectionalLightDemo::DrawScene()
//{
//
...
//}
//
//void DirectionalLightDemo::InitAudio()
//{
...
//}
//
//void DirectionalLightDemo::RenderSprite(DPhoenix::Sprite * sprite, ID3DX11EffectTechnique * tech, bool isHUD)
//{
...
//}
//
//void DirectionalLightDemo::RenderColorPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
//	float scaleX = mScreenScale.x;
...
//}
//
//void DirectionalLightDemo::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
//	float scaleX = mScreenScale.x;
...
//}
//
//void DirectionalLightDemo::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//	
//
//	//create view / projection matrix
