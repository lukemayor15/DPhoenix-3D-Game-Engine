...
//class AnimSpriteDemo : public DPhoenix::Engine
//{
//private:
...
//public:
//	AnimSpriteDemo(HINSTANCE hInstance);
//	~AnimSpriteDemo();
//
...
//	void AnimSpriteDemo::HandleEvents(DPhoenix::IEvent* e);
//
...
//#endif
//
//	AnimSpriteDemo theApp(hInstance);
//
...
//AnimSpriteDemo::AnimSpriteDemo(HINSTANCE hInstance)
//	: Engine(hInstance)
//{
//	mMainWndCaption = "Animated Sprite Demo";
//
//}
//
////destructor (release any memory as necessary)
//AnimSpriteDemo::~AnimSpriteDemo()
//{
...
//bool AnimSpriteDemo::Init(bool fullScreen)
//{
...
//void AnimSpriteDemo::OnResize()
//{
//	Engine::OnResize();
//}
//
////update scene - here is where our update logic for the game loop goes
//void AnimSpriteDemo::UpdateScene(float dt)
//{
...
//}
//
//void AnimSpriteDemo::BuildGeometryBuffers()
//{
...
//}
//
//void AnimSpriteDemo::RenderSprite(DPhoenix::Sprite * sprite, ID3DX11EffectTechnique * tech, bool isHUD)
//{
