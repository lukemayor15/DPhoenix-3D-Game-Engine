...
//class AnimatedMeshDemo : public DPhoenix::Engine
//{
//private:
...
//	int mCollected;
//
//	DPhoenix::BillboardSprite* mBillboard;
//
//	//particle emitter
//	DPhoenix::ParticleEmitter* mParticleEmitter;
//
//	//static mesh
//	DPhoenix::BasicModel* mBasicModel;
//	DPhoenix::BasicModelInstance* mBasicInstance;
//	int mBasicCurrentWaypoint;
//	std::vector<XMFLOAT3> mBasicModelWaypoints;
//
//	//animated mesh
//	DPhoenix::SkinnedModel* mAnimModel;
//	DPhoenix::SkinnedModelInstance* mAnimInstance;
//	int mAnimCurrentWayPoint;
//	std::vector<XMFLOAT3> mAnimModelWayPoints;
//
//	//lighting--------------------------------------
//	//directional lights
...
//
//public:
//	AnimatedMeshDemo(HINSTANCE hInstance);
//	~AnimatedMeshDemo();
//
...
//	void AnimatedMeshDemo::HandleEvents(DPhoenix::IEvent* e);
//
...
//	void AnimatedMeshDemo::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance* model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / spefically handles textured primtives with directional lights abd fog
//	void AnimatedMeshDemo::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / with normal mapping
//	void AnimatedMeshDemo::RenderLitTexNormPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / now wit normal mapping
//	void RenderSkybox(DPhoenix::Sky* skybox, ID3D11DeviceContext* dc);
//
//	void AnimatedMeshDemo::RenderBillboardSprite(DPhoenix::BillboardSprite * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render staic mesh with subsets
//	void AnimatedMeshDemo::RenderBasicModel(DPhoenix::BasicModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new meothd / redner staic mesh with subsets
//	void AnimatedMeshDemo::RenderBasicModelNormal(DPhoenix::BasicModelInstance* model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render sani mesh woth subsets
//	void AnimatedMeshDemo::RenderSkinnedModel(DPhoenix::SkinnedModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render anim mesh with subsets
//	void AnimatedMeshDemo::RenderSkinnedModelNormal(DPhoenix::SkinnedModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//};
//
...
//#endif
//
//	AnimatedMeshDemo theApp(hInstance);
//
...
//AnimatedMeshDemo::AnimatedMeshDemo(HINSTANCE hInstance)
//	: Engine(hInstance)
//{
...
//AnimatedMeshDemo::~AnimatedMeshDemo()
//{
...
//void AnimatedMeshDemo::InitCollectables()
//{
...
//void AnimatedMeshDemo::InitScenery()
//{
...
//bool AnimatedMeshDemo::Init(bool fullScreen)
//{
...
//	mBillboard = new DPhoenix::BillboardSprite();
//	mBillboard->LoadBS("Textures\\Deanyp\\Run.png", &mTexMgr, 7.5f, 10.0f, md3dDevice);
//	mBillboard->SetCurrentFrame(0); mBillboard->mAnimationColumns = 12;
//	mBillboard->mAnimationDirection = 16; mBillboard->SetAnimationRange(0, 11);
//	mBillboard->SetScale(1.0f);	mBillboard->mFlipValue = 1.0f;
//
//	//set inital position and velcoity
//	mPosition.x = 5.0f, mPosition.y = 5.0f, mPosition.z = 5.0f;
//	mBillboard->mPosition = mPosition;
//	//partical emitter
...
//	mParticleEmitter->mSprite->SetScale(1.0f);
//	mParticleEmitter->mSprite->mFlipValue = 1.0f;
//
//	mParticleEmitter->mPosition.y = 10.0f;
//
//	mBasicModel = new DPhoenix::BasicModel(md3dDevice, &mTexMgr,
//		"Models\\exo_gray\\exo_gray.dae", "Models\\exo_gray\\");
//
//	mBasicInstance = new DPhoenix::BasicModelInstance();
//	mBasicInstance->Model = mBasicModel;
//	mBasicInstance->mPosition = XMFLOAT3(100.0f, 50.0f, 100.0f);
//	mBasicInstance->mPrevPosition = XMFLOAT3(200.0f, 50.0f, 200.0f);
//
//	mBasicCurrentWaypoint = 0;
//	mBasicModelWaypoints.push_back(XMFLOAT3(50.0f, 50.0f, 200.0f));
//	mBasicModelWaypoints.push_back(XMFLOAT3(50.0f, 50.0f, 50.0f));
//	mBasicModelWaypoints.push_back(XMFLOAT3(200.0f, 50.0f, 50.0f));
//	mBasicModelWaypoints.push_back(XMFLOAT3(200.0f, 50.0f, 200.0f));
//
//	mAnimModel = new DPhoenix::SkinnedModel(md3dDevice, mTexMgr,
//		"Models\\SoldierAnimations\\SoldierDancing.dae", "Models\\SoldierAnimations\\");
//
...
//	mAnimModel->Animator->LoadNewAnimations("Models\\SoldierAnimations\\SoldierIdle.dae");
...
//	mAnimModel->Animator->LoadNewAnimations("Models\\SoldierAnimations\\SoldierMissileFistSM.dae");
//	mAnimModel->Animator->LoadNewAnimations("Models\\SoldierAnimations\\SoldierRunning.dae");
//	mAnimModel->Animator->LoadNewAnimations("Models\\SoldierAnimations\\SoldierTPoseWithBones.dae");
...
//	//END TOYLAND texture apllication
//
//	mAnimInstance = new DPhoenix::SkinnedModelInstance("", mAnimModel);
//	mAnimInstance->Model = mAnimModel;
//	mAnimInstance->mPosition = XMFLOAT3(100.0f, 50.0f, 100.0f);
//	mAnimInstance->mPrevPosition = XMFLOAT3(200.0f, 50.0f, 200.0f);
//
//	mAnimCurrentWayPoint = 0;
//	
//	mAnimModelWayPoints.push_back(XMFLOAT3(50.0f, 50.0f, 200.0f));
//	mAnimModelWayPoints.push_back(XMFLOAT3(50.0f, 50.0f, 50.0f));
//	mAnimModelWayPoints.push_back(XMFLOAT3(200.0f, 50.0f, 50.0f));
//	mAnimModelWayPoints.push_back(XMFLOAT3(200.0f, 50.0f, 200.0f));
//
...
//void AnimatedMeshDemo::OnResize()
//{
//	Engine::OnResize();
//
...
//void AnimatedMeshDemo::UpdateScene(float dt)
//{
...
//	}
//
//	//update billbaord sprite
//	mBillboard->UpdateBS(dt);
//
//	mParticleEmitter->Update(dt);
//
//	//basic model automation-------------------------------------------
//	float xDistance = mBasicInstance->mPosition.x -
//		mBasicModelWaypoints[mBasicCurrentWaypoint].x;
//	float yDistance = mBasicInstance->mPosition.y -
//		mBasicModelWaypoints[mBasicCurrentWaypoint].y;
//	float zDistance = mBasicInstance->mPosition.z -
//		mBasicModelWaypoints[mBasicCurrentWaypoint].z;
//
//	//are we thiin 1 unit of the waypoint
//	if (std::abs(xDistance) < 1.0f &&
//		std::abs(yDistance) < 1.0f &&
//		std::abs(zDistance) < 1.0f)
//	{
//		//if so go to the next waypoint 
//		mBasicCurrentWaypoint++;
//		if (mBasicCurrentWaypoint >= mBasicModelWaypoints.size())
//			mBasicCurrentWaypoint = 0;
//	}
//
//	//nromalise the vecotr (for direction) and store as xmfloat3
//	facingVec = XMVector3Normalize(
//		XMVectorSubtract(
//			XMLoadFloat3(&mBasicModelWaypoints[mBasicCurrentWaypoint]),
//			XMLoadFloat3(&mBasicInstance->mPosition)
//		)
//	);
//
//	XMStoreFloat3(&facingDir, facingVec);
//
//	//set the orward vector for the modle and update velocity forwards
//	//realtive mocment based on facinf direction
//	mBasicInstance->mForwardVector = facingDir;
//	mBasicInstance->mRelativeVelocity = XMFLOAT3(0.0f, 0.0f, 50.0f);
//	mBasicInstance->Update(dt, true);
//	mBasicInstance->SetFacingRotation(0);
//
//	//anime model automation-------------------------------------------
//	
//	 xDistance = mAnimInstance->mPosition.x -
//		 mAnimModelWayPoints[mAnimCurrentWayPoint].x;
//	yDistance = mAnimInstance->mPosition.y -
//		mAnimModelWayPoints[mAnimCurrentWayPoint].y;
//	 zDistance = mAnimInstance->mPosition.z -
//		 mAnimModelWayPoints[mAnimCurrentWayPoint].z;
//	
//
//	//are we thiin 1 unit of the waypoint
//	if (std::abs(xDistance) < 1.0f &&
...
//	{
//		//if so go to the next waypoint 
//		mAnimCurrentWayPoint++;
//		if (mAnimCurrentWayPoint >= mAnimModelWayPoints.size())
//			mAnimCurrentWayPoint = 0;
//	}
//
//	//nromalise the vecotr (for direction) and store as xmfloat3
//	facingVec = XMVector3Normalize(
//		XMVectorSubtract(
//			XMLoadFloat3(&mAnimModelWayPoints[mAnimCurrentWayPoint]),
//			XMLoadFloat3(&mAnimInstance->mPosition)
//		)
//	);
//
//	XMStoreFloat3(&facingDir, facingVec);
...
//	//set the orward vector for the modle and update velocity forwards
//	//realtive mocment based on facinf direction
//	mAnimInstance->mForwardVector = facingDir;
//	mAnimInstance->mRelativeVelocity = XMFLOAT3(0.0f, 0.0f, 50.0f);
//	mAnimInstance->Update(dt, true);
//	mAnimInstance->SetFacingRotation(0);
//
//	//pint lights--------------------------------------------------------
...
//}
//
//void AnimatedMeshDemo::BuildGeometryBuffers()
//{
...
//}
//
//void AnimatedMeshDemo::DrawScene()
//{
//
...
//
//	//set uo the vertecx input
//	//would need to chane for diffrent rendering types
//	md3dImmediateContext->IASetInputLayout(DPhoenix::InputLayouts::PosNormalTexTan);
//
//	RenderBillboardSprite(mBillboard, activeLitBillboardTech);
//
...
//
//	//set up the vertec input layout
//	//change for diffrent rendering
//	md3dImmediateContext->IASetInputLayout(DPhoenix::InputLayouts::PosNormalTexTan);
//
//	//RenderBasicModel(mBasicInstance, activeLitTexTech);
...
//	md3dImmediateContext->IASetInputLayout(DPhoenix::InputLayouts::PosNormalTexTanSkinned);
//
//	RenderSkinnedModelNormal(mAnimInstance, activeLitTexNormSkinnedTech);
//
...
//			break;
//		case DIK_O:
//			mAnimInstance->Model->Animator->PrevAnimation();
//			break;
//		case DIK_P:
//			mAnimInstance->Model->Animator->NextAnimation();
//		}
//	}
//	break;
//
...
//}
//
//void AnimatedMeshDemo::InitAudio()
//{
...
//}
//
//void AnimatedMeshDemo::RenderSprite(DPhoenix::Sprite * sprite, ID3DX11EffectTechnique * tech, bool isHUD)
//{
...
//}
//
//void AnimatedMeshDemo::RenderColorPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
//	float scaleX = mScreenScale.x;
...
//}
//
//void AnimatedMeshDemo::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
//	float scaleX = mScreenScale.x;
...
//}
//
//void AnimatedMeshDemo::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
...
//}
//
//void AnimatedMeshDemo::RenderLitTexNormPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
...
//void AnimatedMeshDemo::RenderSkybox(DPhoenix::Sky* skybox,
//	ID3D11DeviceContext* dc)
//{
//	skybox->Draw(dc, mCamera);
//}
//
//void AnimatedMeshDemo::RenderBillboardSprite(DPhoenix::BillboardSprite * sprite, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
...
//
//	DPhoenix::Effects::LitBillboardFX->SetWorld(world);
//
//	XMMATRIX worldViewProj = XMMatrixMultiply(world, viewProj);
...
//
//	DPhoenix::Effects::LitBillboardFX->SetSpotLights(mSpotLightsArray);
//	DPhoenix::Effects::LitBillboardFX->SetSpotLightCount(mNumSpotLights);
//
//	DPhoenix::Effects::LitBillboardFX->SetColumn(sprite->GetCurrentFrame());		//co;/frame
...
//	DPhoenix::Effects::LitBillboardFX->SetOpacity(sprite->mOpacityValue);			// opacity value
...
//}
//
//void AnimatedMeshDemo::RenderBasicModel(DPhoenix::BasicModelInstance * model, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
...
//		{
//			//get pointer to model / mesh data
...
//			//if we have a diffuse map the set it for the subset
...
//}
//
//void AnimatedMeshDemo::RenderBasicModelNormal(DPhoenix::BasicModelInstance * model, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
...
//}
//
//void AnimatedMeshDemo::RenderSkinnedModel(DPhoenix::SkinnedModelInstance * model, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
...
//}
//
//void AnimatedMeshDemo::RenderSkinnedModelNormal(DPhoenix::SkinnedModelInstance * model, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
