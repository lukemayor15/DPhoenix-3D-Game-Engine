...
//class LITSWeapons : public DPhoenix::Engine
//{
//private:
...
//
//public:
//	LITSWeapons(HINSTANCE hInstance);
//	~LITSWeapons();
//
...
//	void LITSWeapons::HandleEvents(DPhoenix::IEvent* e);
//
...
//	void LITSWeapons::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / specifically handles textured primitives with directional lights
//	//and fog
//	void LITSWeapons::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / now with normal mapping!
//	void LITSWeapons::RenderLitTexNormPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / now with normal mapping!
...
//	void LITSWeapons::RenderBillboardSprite(DPhoenix::BillboardSprite * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render static mesh with subsets
//	void LITSWeapons::RenderBasicModel(DPhoenix::BasicModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render static mesh with subsets
//	void LITSWeapons::RenderBasicModelNormal(DPhoenix::BasicModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render animated lit mesh with subsets
//	void LITSWeapons::RenderSkinnedModel(DPhoenix::SkinnedModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render animated lit normal mapped mesh with subsets
//	void LITSWeapons::RenderSkinnedModelNormal(DPhoenix::SkinnedModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//
//#pragma region LITSMethods
//
//	bool LITSWeapons::CheckPointInRect(int pointX, int pointY, RECT rect);
//	void LITSWeapons::CheckMouseHoverMenu();
//	void LITSWeapons::CheckMouseClickMenu();
//
//	void LITSWeapons::CheckMouseHoverTurns();
//	void LITSWeapons::CheckMouseClickTurns();
//
//	//for movment
//	void LITSWeapons::CheckMouseClickRoute();
//	void LITSWeapons::CheckSelectableRoute();
//	void LITSWeapons::ResetPath();
//
//	//for actions
//	void LITSWeapons::CheckMouseHoverActions();
//	void LITSWeapons::CheckMouseClickActions();
//
//	void LITSWeapons::ResetTargeting();
//	void LITSWeapons::CheckMouseClickTarget();
//
//	XMFLOAT2 LITSWeapons::Convert3Dto2DPoint(XMFLOAT3 pos3d);
...
//LITSWeapons::LITSWeapons(HINSTANCE hInstance)
//	: Engine(hInstance)
//{
...
//bool LITSWeapons::Init(bool fullScreen)
//{
...
//void LITSWeapons::UpdateScene(float dt)
//{
...
//}
//
//void LITSWeapons::BuildGeometryBuffers()
//{
...
//}
//
//void LITSWeapons::InitAudio()
//{
//
//}
//
//void LITSWeapons::RenderSprite(DPhoenix::Sprite * sprite, ID3DX11EffectTechnique * tech, bool isHUD)
//{
...
//}
//
//void LITSWeapons::RenderColorPrimitive(DPhoenix::PrimitiveInstance * model,
//	ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
...
//void LITSWeapons::RenderSkybox(DPhoenix::Sky* skybox,
//	ID3D11DeviceContext* dc)
//{
//	skybox->Draw(dc, mCamera);
//}
//
//void LITSWeapons::RenderBillboardSprite(DPhoenix::BillboardSprite * sprite,
//	ID3DX11EffectTechnique * tech)
//{
//	//create view / projection matrix
//	XMMATRIX view = mCamera->GetView();
