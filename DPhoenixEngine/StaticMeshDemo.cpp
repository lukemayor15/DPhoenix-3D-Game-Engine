...
//class StaticMeshDemo : public DPhoenix::Engine
//{
//private:
...
//
//public:
//	StaticMeshDemo(HINSTANCE hInstance);
//	~StaticMeshDemo();
//
...
//	void StaticMeshDemo::HandleEvents(DPhoenix::IEvent* e);
//
...
//	void StaticMeshDemo::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance* model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / spefically handles textured primtives with directional lights abd fog
//	void StaticMeshDemo::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / with normal mapping
//	void StaticMeshDemo::RenderLitTexNormPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / now wit normal mapping
//	void RenderSkybox(DPhoenix::Sky* skybox, ID3D11DeviceContext* dc);
//
//	void StaticMeshDemo::RenderBillboardSprite(DPhoenix::BillboardSprite * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / render staic mesh with subsets
//	void StaticMeshDemo::RenderBasicModel(DPhoenix::BasicModelInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new meothd / redner staic mesh with subsets
//	void StaticMeshDemo::RenderBasicModelNormal(DPhoenix::BasicModelInstance* model,
//		ID3DX11EffectTechnique * tech);
//
//};
//
...
//#endif
//
//	StaticMeshDemo theApp(hInstance);
//
...
//StaticMeshDemo::StaticMeshDemo(HINSTANCE hInstance)
//	: Engine(hInstance)
//{
...
//void StaticMeshDemo::InitCollectables()
//{
...
//void StaticMeshDemo::InitScenery()
//{
...
//bool StaticMeshDemo::Init(bool fullScreen)
//{
...
//void StaticMeshDemo::UpdateScene(float dt)
//{
...
//}
//
//void StaticMeshDemo::BuildGeometryBuffers()
//{
...
//}
//
//void StaticMeshDemo::RenderSprite(DPhoenix::Sprite * sprite, ID3DX11EffectTechnique * tech, bool isHUD)
//{
...
//}
//
//void StaticMeshDemo::RenderColorPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
//	float scaleX = mScreenScale.x;
...
//}
//
//void StaticMeshDemo::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
//	float scaleX = mScreenScale.x;
...
//}
//
//void StaticMeshDemo::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
...
//}
//
//void StaticMeshDemo::RenderLitTexNormPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
...
//void StaticMeshDemo::RenderSkybox(DPhoenix::Sky* skybox,
//	ID3D11DeviceContext* dc)
//{
//	skybox->Draw(dc, mCamera);
//}
//
//void StaticMeshDemo::RenderBillboardSprite(DPhoenix::BillboardSprite * sprite, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
...
//}
//
//void StaticMeshDemo::RenderBasicModel(DPhoenix::BasicModelInstance * model, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
...
//}
//
//void StaticMeshDemo::RenderBasicModelNormal(DPhoenix::BasicModelInstance * model, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
