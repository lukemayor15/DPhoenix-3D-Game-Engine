...
//class BillBoardSpriteDemo : public DPhoenix::Engine
//{
//private:
...
//
//public:
//	BillBoardSpriteDemo(HINSTANCE hInstance);
//	~BillBoardSpriteDemo();
//
...
//	void BillBoardSpriteDemo::HandleEvents(DPhoenix::IEvent* e);
//
...
//	void BillBoardSpriteDemo::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance* model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / spefically handles textured primtives with directional lights abd fog
//	void BillBoardSpriteDemo::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / with normal mapping
//	void BillBoardSpriteDemo::RenderLitTexNormPrimitive(DPhoenix::PrimitiveInstance * model,
//		ID3DX11EffectTechnique * tech);
//
//	//new method / now wit normal mapping
//	void RenderSkybox(DPhoenix::Sky* skybox, ID3D11DeviceContext* dc);
//
//	void BillBoardSpriteDemo::RenderBillboardSprite(DPhoenix::BillboardSprite * model,
//		ID3DX11EffectTechnique * tech);
//};
//
...
//#endif
//
//	BillBoardSpriteDemo theApp(hInstance);
//
...
//BillBoardSpriteDemo::BillBoardSpriteDemo(HINSTANCE hInstance)
//	: Engine(hInstance)
//{
...
//BillBoardSpriteDemo::~BillBoardSpriteDemo()
//{
...
//void BillBoardSpriteDemo::InitCollectables()
//{
...
//void BillBoardSpriteDemo::InitScenery()
//{
...
//bool BillBoardSpriteDemo::Init(bool fullScreen)
//{
...
//void BillBoardSpriteDemo::OnResize()
//{
//	Engine::OnResize();
//
...
//void BillBoardSpriteDemo::UpdateScene(float dt)
//{
...
//}
//
//void BillBoardSpriteDemo::BuildGeometryBuffers()
//{
...
//}
//
//void BillBoardSpriteDemo::DrawScene()
//{
//
...
//}
//
//void BillBoardSpriteDemo::InitAudio()
//{
...
//}
//
//void BillBoardSpriteDemo::RenderSprite(DPhoenix::Sprite * sprite, ID3DX11EffectTechnique * tech, bool isHUD)
//{
...
//}
//
//void BillBoardSpriteDemo::RenderColorPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
//	float scaleX = mScreenScale.x;
...
//}
//
//void BillBoardSpriteDemo::RenderBasicTexPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//	//here we calculate the scale on X and Y based on the client width / height
//	//vs. our original resolution 
//	float scaleX = mScreenScale.x;
...
//}
//
//void BillBoardSpriteDemo::RenderLitTexPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
...
//}
//
//void BillBoardSpriteDemo::RenderLitTexNormPrimitive(DPhoenix::PrimitiveInstance * model, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
...
//void BillBoardSpriteDemo::RenderSkybox(DPhoenix::Sky* skybox,
//	ID3D11DeviceContext* dc)
//{
//	skybox->Draw(dc, mCamera);
//}
//
//void BillBoardSpriteDemo::RenderBillboardSprite(DPhoenix::BillboardSprite * sprite, ID3DX11EffectTechnique * tech)
//{
//
//
//	//create view / projection matrix
